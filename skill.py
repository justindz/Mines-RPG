...
class Skill(ability.Ability):
    def __init__(self, _name, _description, _level, _cost, _effects, _weapon_type, _area=0, _cooldown=0,
                 _area_modifiable=False,
                 _cooldown_modifiable=False):
        super().__init__(_name, _description, _level, _cost, _effects, _area, _cooldown, _area_modifiable,
                         _cooldown_modifiable)
...
skills = {
    'slash': Skill('Slash', 'Slash skill description.', 1,
                   ...
                   WeaponType.sword, 1, 1, True, False),
}
