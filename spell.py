...
spells = {
    ...
    'regenerate': Spell('Regenerate', 'Regenerate description.', {'h': 0, 's': 0, 'm': 10},
                        [Effect(EffectType.buff, Elements.water, _dice_value=2, _stat='health_regen',
                                _status_effect_name='Mending', _effect_turns=4)], [], [], _base_crit_chance=0.01,
    ...
    'weaken': Spell('Weaken', 'Weaken description.', {'h': 0, 's': 0, 'm': 8},
                    [Effect(EffectType.debuff, Elements.earth, _dice_value=10, _stat='strength',
                            _status_effect_name='Weakened', _effect_turns=3)], [Elements.earth], []),
    'stupefy': Spell('Stupefy', 'Stupefy description.', {'h': 0, 's': 0, 'm': 8},
                     [Effect(EffectType.debuff, Elements.fire, _dice_value=10, _stat='intelligence',
                             _status_effect_name='Stupefied', _effect_turns=3)], [Elements.fire], []),
    'exhaust': Spell('Exhaust', 'Exhaust description.', {'h': 0, 's': 0, 'm': 8},
                     [Effect(EffectType.debuff, Elements.electricity, _dice_value=10, _stat='dexterity',
                             _status_effect_name='Exhausted', _effect_turns=3)], [Elements.electricity], []),
    'discourage': Spell('Discourage', 'Discourage description.', {'h': 0, 's': 0, 'm': 8},
                        [Effect(EffectType.debuff, Elements.water, _dice_value=10, _stat='willpower',
                                _status_effect_name='Discouraged', _effect_turns=3)], [Elements.water], []),
    # Buffs
    'haste': Spell('Haste', 'Haste description.', {'h': 0, 's': 0, 'm': 8},
                   [Effect(EffectType.buff, Elements.electricity, _dice_value=10, _stat='bonus_init',
                           _status_effect_name='Hasted', _effect_turns=2)], [], [], _targets_enemies=False),
    'empower': Spell('Empower', 'Empower description.', {'h': 0, 's': 0, 'm': 8},
                     [Effect(EffectType.buff, Elements.earth, _dice_value=10, _stat='strength',
                             _status_effect_name='Empowered', _effect_turns=3)], [Elements.earth], []),
    'enlighten': Spell('Enlighten', 'Enlighten description.', {'h': 0, 's': 0, 'm': 8},
                       [Effect(EffectType.buff, Elements.fire, _dice_value=10, _stat='intelligence',
                               _status_effect_name='Enlightened', _effect_turns=3)], [Elements.fire], []),
    'unleash': Spell('Unleash', 'Unleash description.', {'h': 0, 's': 0, 'm': 8},
                     [Effect(EffectType.buff, Elements.electricity, _dice_value=10, _stat='dexterity',
                             _status_effect_name='Unleashed', _effect_turns=3)], [Elements.electricity], []),
    'inspire': Spell('Inspire', 'Inspire description.', {'h': 0, 's': 0, 'm': 8},
                     [Effect(EffectType.buff, Elements.water, _dice_value=10, _stat='willpower',
                             _status_effect_name='Inspired', _effect_turns=3)], [Elements.water], []),
    # Summons
