...
spells = {
    ...
    'lesser_ward': Spell(
        'Lesser Ward',
        'Lesser Ward description.',
        {'h': 0, 's': 0, 'm': 10},
        [
            Effect(EffectType.buff, Elements.water, _dice_value=0.02, _stat='bonus_earth_res',
                   _status_effect_name='Warded: Earth', _effect_turns=4),
            Effect(EffectType.buff, Elements.water, _dice_value=0.02, _stat='bonus_fire_res',
                   _status_effect_name='Warded: Fire', _effect_turns=4),
            Effect(EffectType.buff, Elements.water, _dice_value=0.02, _stat='bonus_electricity_res',
                   _status_effect_name='Warded: Electricity', _effect_turns=4),
            Effect(EffectType.buff, Elements.water, _dice_value=0.02, _stat='bonus_water_res',
                   _status_effect_name='Warded: Water', _effect_turns=4),
        ],
        [],
        [],
    ),
    'focused_lesser_ward': Spell(
        'Focused Lesser Ward',
        'Focused Lesser Ward description.',
        {'h': 0, 's': 0, 'm': 10},
        [
            Effect(EffectType.buff, Elements.water, _dice_value=0.05, _stat='bonus_earth_res',
                   _status_effect_name='Warded: Earth', _effect_turns=2),
            Effect(EffectType.buff, Elements.water, _dice_value=0.05, _stat='bonus_fire_res',
                   _status_effect_name='Warded: Fire', _effect_turns=2),
            Effect(EffectType.buff, Elements.water, _dice_value=0.05, _stat='bonus_electricity_res',
                   _status_effect_name='Warded: Electricity', _effect_turns=2),
            Effect(EffectType.buff, Elements.water, _dice_value=0.05, _stat='bonus_water_res',
                   _status_effect_name='Warded: Water', _effect_turns=2),
        ],
        [],
        [],
    ),
    'calcified_skin': Spell(
        'Calcified Skin',
        'TODO',
        {'h': 0, 's': 0, 'm': 20},
        [
            Effect(EffectType.buff, Elements.earth, _dice_value=0.05, _stat='bonus_earth_res',
                   _status_effect_name='Warded: Earth', _effect_turns=3),
        ],
        [],
        [Elements.earth],
    ),
    'quenching_skin': Spell(
        'Quenching Skin',
        'TODO',
        {'h': 0, 's': 0, 'm': 20},
        [
            Effect(EffectType.buff, Elements.fire, _dice_value=0.05, _stat='bonus_fire_res',
                   _status_effect_name='Warded: Fire', _effect_turns=3),
        ],
        [],
        [Elements.fire],
    ),
    'insulated_skin': Spell(
        'Insulated Skin',
        'TODO',
        {'h': 0, 's': 0, 'm': 20},
        [
            Effect(EffectType.buff, Elements.water, _dice_value=0.05, _stat='bonus_electricity_res',
                   _status_effect_name='Warded: Electricity', _effect_turns=3),
        ],
        [],
        [Elements.electricity],
    ),
    'absorbent_skin': Spell(
        'Absorbent Skin',
        'TODO',
        {'h': 0, 's': 0, 'm': 20},
        [
            Effect(EffectType.buff, Elements.water, _dice_value=0.05, _stat='bonus_water_res',
                   _status_effect_name='Warded: Water', _effect_turns=3),
        ],
        [],
        [Elements.water],
    ),
